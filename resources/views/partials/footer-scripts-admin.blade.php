    ...
    <script src="{{URL::asset('js/bootstrap-validator.min.js')}}"></script>
    <script src="{{URL::asset('js/jquery.steps.min.js')}}"></script>
    <script src="{{URL::asset('js/jquery.validate.min.js')}}"></script>
    <script src="{{URL::asset('js/jquery.masknumber.js')}}"></script>
    ...
    <script src="{{URL::asset('js/jquery.disableAutoFill.min.js')}}"></script>
