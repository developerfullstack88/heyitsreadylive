...
<div class="row termsServices">
	 <div class="col-md-12 col-12">
      ...
      <h1 class="text-center">Hey It’s Ready Customer App</h1>
      ...
      <h1 class="text-center font-weight-900">SCHEDULE "A"</h1>
      <h2><u>RECOMMEND DEVICES for the QRS Reporting App</u></h2>
...
<div class="row mt-10 termsServices">
  ...
  <div class="col-md-12" class="termsServices">
    ...
    <h1 class="text-center font-weight-900">SCHEDULE "B"</h1>
    <h3><u>RECOMMEND Web Browsers</u></h3>
