         ...
         @method('PUT')
          ...
          <div class="form-group">
            {{Form::label('name',trans('site.business_name_label'))}}
						...
						data-toggle="tooltip" data-placement="right" title="{{__('site.business_name_tooltip')}}" data-container="body"></i>
              ...
              'required'=>true,'readonly'=>true]
	            ...
	            <img class="menu-edit-img" src="{{asset($site->cover_image_thumbnail)}}"/>
					...
					<div class="form-group">
						...
						<i class="fas fa-question-circle"
						data-toggle="tooltip" data-placement="top" title="{{__('site.site_cover_image_tooltip')}}" data-container="body"></i>
						{{Form::file('cover_image',[])}}
					</div>
					<div>
            {{Form::label('category', trans('site.site_category'))}}
						<i class="fas fa-question-circle"
						data-toggle="tooltip" data-placement="right" title="{{__('site.site_category_tooltip')}}" data-container="body"></i>
            ...
            {{Form::label('manager_id', trans('site.site_manager_label'))}}
						<i class="fas fa-question-circle"
						data-toggle="tooltip" data-placement="right" title="{{__('site.site_manager_tooltip')}}" data-container="body"></i>
          ...
          <div class="form-group">
            {{Form::label('address',trans('site.address_label'))}}
						<i class="fas fa-question-circle"
						data-toggle="tooltip" data-placement="right" title="{{__('site.site_address_tooltip')}}" data-container="body"></i>
