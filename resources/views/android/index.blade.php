...
<div class="row">
  <section class="wrapper wrapper-logo">
    <div class="col-lg-12 col-12 text-center mt-2">
      <h1 class="text-center">Hey It's Ready Android Help</h1>
  ...
  <section class="wrapper main-menu-wrapper">
    ...
    <div id="android-update-profile">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/add_a_profile_pic_android.png')}}"/></p>
          <li class="li-heading">Choose “Profile” from the menu.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/update_profile_1.png')}}"/></p>
    ...
    <div id="android-walkin-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/confirm_order.png')}}"/></p>
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/order_confirmed.png')}}"/></p>
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/order_ready.png')}}"/></p>
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/order_completed.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-scan-walkin-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/scan_qr_code_1.png')}}"/></p>
        </ol>
      </div>
    </div>
    ...
    <div id="android-delete-past-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/Select_my_orders.png')}}"/></p>
          <li class="li-heading">Select “Past Orders” in Order History</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/select_past_orders.png')}}"/></p>
          <li class="li-heading">Swipe right to left on any order to display the delete button and select “Delete”.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/Slide_to_delete.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-view-cancelled-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          <li class="li-heading">Select the menu in the upper left hand corner of your home screen.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/home_cancelled_orders.png')}}"/></p>
          <li class="li-heading">Select “My Orders” from the menu list.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/selec_my_orders.png')}}"/></p>
          <li class="li-heading">Select “Cancelled Orders”.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/select_cancelled_orders.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-get-directions-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        ...
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/directions_from_icon.png')}}"/></p>
        </ol>
      </div>
      <div class="col-lg-12 col-12 mt-2">
        ...
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/directions_from_order.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-add-profile-photo">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/Select_Profile.png')}}"/></p>
          <li class="li-heading">Select the Photo icon.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/Photo_icon.png')}}"/></p>
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/Select_camera_or_gallery.png')}}"/></p>
          <li class="li-heading">Select “Update” to save the changes.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/select_update.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-map-markers-for">
      ...
      <div class="col-lg-12 col-12 mt-2">
        ...
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/Map_markers.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-search-for-business">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/change_location.png')}}"/></p>
          <li class="li-heading">Enter a city by name and then choose from the drop down list.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/search_new_city_name.png')}}"/></p>
        </ol>
      </div>
    </div>
    <div id="android-call-in-orders">
      ...
      <div class="col-lg-12 col-12 mt-2">
        <ol id="sub-ul">
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/my_order_confirmed.png')}}"/></p>
          ...
          <p class="img-li"><img src="{{asset('img/Help/Android/Order_ready.png')}}"/></p>
          <li class="li-heading">Once you have picked up your order you will receive a final notification that your order has been completed.</li>
          <p class="img-li"><img src="{{asset('img/Help/Android/order_completed1.png')}}"/></p>
        </ol>
      </div>
    </div>
  </section>
