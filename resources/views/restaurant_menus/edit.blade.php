...
<div class="row createSitePage">
    ...
    @endif
	  <section class="card">
		  <header class="card-header font-title">@lang('restaurant_menu.form_edit_menu')</header>
			<div class="card-body" id="siteAddCardBody">
        {{ Form::model($menu,array('action'=> array('RestaurantMenuController@update',$menu->id),'files'=>true)) }}
        @method('PUT')
          {{Form::token()}}
...
<script type="text/javascript">
	var start_time='{{date("h:i A",strtotime($menu->start_time))}}';
	var end_time='{{date("h:i A",strtotime($menu->end_time))}}';
