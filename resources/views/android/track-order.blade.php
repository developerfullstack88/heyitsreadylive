...
<div class="row mt-3" id="createOrderPage">
	<div class="col-lg-offset-2 col-lg-8 col-12 frmctr">
      ...
      <div class="form-group form-check text-center">
          {{Form::button('Update',["class"=>"btn btn-lg btn-primary track-order-detail"])}}
      </div>
      {{ Form::close() }}
		</section>
    @if($orderInfo)
        ...
        <div class="row p-details">
          <div class="col-md-12">
            ...
            <div class="bio-row d-none" style="width:100%">
              ...
              <p class="text-center extra-bold-black">Please download the FREE Hey It's Ready App at <a href="javascript:void(0);"><b>www.heyitsready.com</b></a></p>
